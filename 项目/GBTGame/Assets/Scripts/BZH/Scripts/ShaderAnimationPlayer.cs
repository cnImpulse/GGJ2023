...
public class ShaderAnimationPlayer : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		targetRenderer.material.SetFloat(propertyCode, bar);
		InvokePlay();
	}
    ...
    public void ReverseMode(float dd, bool disappear = true)
    {
	    disappearDuration = dd;
	    ReverseMode(disappear);
    }
}
