...
public partial class HUDForm
{
	...
	private void InitComponent()
	{
		...
		m_imgFerLim = autoBind.itemList[2].obj.GetComponent<Image>();
		m_scrollbarOxygen = autoBind.itemList[3].obj.GetComponent<Scrollbar>();
		m_imgOxyLim = autoBind.itemList[4].obj.GetComponent<Image>();
		m_scrollbarWater = autoBind.itemList[5].obj.GetComponent<Scrollbar>();
		m_imgWaterLim = autoBind.itemList[6].obj.GetComponent<Image>();
