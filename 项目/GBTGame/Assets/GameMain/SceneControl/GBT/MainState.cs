...
namespace MyGameFrameWork
{
    public class MainState : ISceneState
    {
        ...
        void GameOver(IEventArgs eventArgs)
        {
            ...
            Debug.Log("GameOver");
            //UISystem.Instance.OpenUIForm(Data_UIFormID.key_GameOverForm,new GameOverStruct("��ʧ����",true,cuur_level));
        ...
        void GameOverOK()
        {
            ...
            Enity1.SetActive(false);
            UISystem.Instance.OpenUIForm(Data_UIFormID.key_GameOverForm, new GameOverStruct("��ϲͨ����" + (cuur_level + 1).ToString() + "��", false, cuur_level));
        }
